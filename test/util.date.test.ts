...
import {buildDateRange, buildFutureDates, formatDateLabel, isValidISODate,} from '../src/util/date.js';
...
describe('util/date', () => {
    ...
    describe('buildDateRange', () => {
        ...
        it('handles month boundaries correctly', () => {
            ...
            expect(r).toEqual(['2025-08-30', '2025-08-31', '2025-09-01', '2025-09-02']);
        });
