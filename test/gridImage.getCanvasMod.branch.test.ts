        ...
        default: {
          createCanvas: (w: number, h: number) => ({
            ...
            getContext: () => ({
              ...
              beginPath: () => {}, arc: () => {}, closePath: () => {}, clip: () => {}, save: () => {}, restore: () => {}, drawImage: () => {},
              set fillStyle(_v: any) {}, get fillStyle() { return '#000'; },
              set font(_v: any) {}, get font() { return 'bold 10px sans-serif'; },
              set textBaseline(_v: any) {}, get textBaseline() { return 'alphabetic'; },
            }),
